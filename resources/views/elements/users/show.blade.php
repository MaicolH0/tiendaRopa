        ...
        <div class="col-md-10 offset-md-1">
            ...
            <div>
                ...
                <div class="mb-3">
                    ...
                    <div class="">
                        <input id="birthdate" type="text" class="form-control @error('birthdate') is-invalid @enderror" name="birthdate" value="{{ $user->birthdate }}" disabled>
                    </div>
                </div>
                ...
                <div class="d-grid gap-2 mb-3">
                    <a href="{{ route('users.index') }}" class="btn btn-primary btn-block" style="background-color: #9B2B2B"><i class="fa fa-arrow-left mx-2"></i> Volver </a>
                </div>
